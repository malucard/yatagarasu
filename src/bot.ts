...
import { categoryCommands, embedCommands, threadpinCommands } from "./commands/general";
import { moveCommands, archivelpCommands, upgradelpCommands } from "./commands/lpcommands";
