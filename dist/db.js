...
let collection;
function init_db() {
    client = new mongodb_1.MongoClient("mongodb://yatagarasu-mafia-bot:LKsg2x25cN4jf8bU@yatagarasu-mafia-shard-00-00-uwyry.mongodb.net:27017,yatagarasu-mafia-shard-00-01-uwyry.mongodb.net:27017,yatagarasu-mafia-shard-00-02-uwyry.mongodb.net:27017/test?ssl=true&replicaSet=yatagarasu-mafia-shard-0&authSource=admin&retryWrites=true&w=majority", { useNewUrlParser: true });
